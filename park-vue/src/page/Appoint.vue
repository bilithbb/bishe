<template>
    ...
    <el-form-item >
        ...
        <el-input v-model="query.carNumber" placeholder="车牌号" clearable></el-input>
          ...
          <el-button @click="reset()">重置</el-button>
            ...
            <el-button type="primary" @click="addAppointInfo">添加</el-button>
        </el-form-item>
                <el-form-item v-if="userType ===1">
            <el-button :disabled="this.multipleSelection.length === 0" type="danger" @click="delBatchAppointInfo">批量删除</el-button>
        </el-form-item>
     ...
     <el-table-column prop="totalPrice" label="总价" header-align="center" align="center">
       ...
       <el-table-column prop="updateTime" label="更新时间" width="160" header-align="center" align="center"></el-table-column>
            ...
            <template slot-scope="scope">
                <el-button type="success"  size="small" v-if="userType ===1 || true" @click="updateAppointInfo(scope.row)">更新</el-button>
                <el-button type="danger"  size="small" v-if="userType ===1 || true" @click="delAppointInfo(scope.row.id)">删除</el-button>
            </template>
        </el-table-column>
         </el-table>
      <el-pagination
 ...
 <el-dialog  :visible.sync="addOrUpdateVisible" :title="!form.id ? '新增' : '编辑'" :close-on-click-modal="false" :close-on-press-escape="false">
    ...
    <el-form-item label="结束时间" prop="endTime" v-if="form.status === 4">
      <el-date-picker
              class="runPicker"
